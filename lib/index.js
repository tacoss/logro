...
class Logro {
  ...
  message(msg, data, type, guid) { this.print(msg, type, data, guid); }
  error(msg, guid, err) { this.exception(msg, err, guid); }
  warn(msg, guid, err) { this.failure(msg, err, guid); }

  info(msg, type, data, guid) {
    this.log.debug({
      guid,
      on: `${type} -> ${msg}`,
